...
Source0  : https://github.com/libcheck/check/releases/download/0.14.0/check-0.14.0.tar.gz
...
%prep
%setup -q -n check-0.14.0
cd %{_builddir}/check-0.14.0
pushd ..
cp -a check-0.14.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580146176
...
cp %{_builddir}/check-0.14.0/COPYING.LESSER %{buildroot}/usr/share/package-licenses/check/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/check-0.14.0/doc/example/cmake/COPYING-CMAKE-SCRIPTS.txt %{buildroot}/usr/share/package-licenses/check/77976f406ba34009d9ba5a43b882fe6de68e5175
pushd ../build32/
%make_install32
