...
Source0  : https://github.com/libcheck/check/releases/download/0.11.0/check-0.11.0.tar.gz
...
%prep
%setup -q -n check-0.11.0
pushd ..
cp -a check-0.11.0 build32
popd

%build
export LANG=C
export SOURCE_DATE_EPOCH=1488408853
